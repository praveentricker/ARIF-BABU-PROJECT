...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`┄┅══❁ADMIN BOT❁══┅┄
   [1] NAME: 𒁍OWNER ABHI BABU 
   [2] Facebook: 𒁍 https://www.facebook.com/profile.php?id=61555214872841
   [3] Thanks for using 𒁍 ${global.config.BOTNAME} bot`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(encodeURI(`https://www.facebook.com/profile.php?id=61555214872841`)).pipe(
